...
angular.module('eu.crismaproject.worldstateAnalysis.controllers').controller('eu.crismaproject.worldstateAnalysis.controllers.worldstateRankingTableDirectiveController', [
  ...
  function ($scope, $filter, NgTableParams, Worldstates, ccs, as, ngDialog) {
    ...
    ctrl.insertAtCorrectTablePosition = function (tableArr, newTableItem) {
      var i, insertPosition, updateRank, tableItem, score;
    ...
    ctrl.addWorldstateToTableData = function (ws) {
      ...
      ctrl.insertAtCorrectTablePosition($scope.tableData, newTableItem);  //                ctrl.refreshTable();
    };
      ...
      if ($scope.tableParams) {
        ...
        $scope.tableParams = new NgTableParams({
          ...
          getData: function ($defer, params) {
            ...
            var orderedData;
            orderedData = params.sorting() ? $filter('orderBy')($scope.tableData, params.orderBy()) : $scope.tableData;
