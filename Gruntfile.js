...
//                    'po/index.pot': ['app/index.html'],
        ...
        concat: {
            dist: {
                src: ['<%= yeoman.app %>/scripts/services/analysisService.js', '<%= yeoman.app %>/scripts/controllers/indicatorCriteriaTableDirectiveController.js', '<%= yeoman.app %>/scripts/directives/indicatorCriteriaTableDirective.js', '<%= yeoman.app %>/scripts/**/*.js'],
    ...
    grunt.registerTask('gt-extract', [
        'nggettext_extract'
    ]);
    
    grunt.registerTask('gt-compile',[
        'nggettext_compile'
    ]);
